...
DELETE FROM public.project_tasks WHERE id IN ('c1000000-0000-0000-0000-000000000000');
DELETE FROM public.projects WHERE id IN ('b1000000-0000-0000-0000-000000000000', 'b2000000-0000-0000-0000-000000000000', 'b3000000-0000-0000-0000-000000000000');
...
INSERT INTO public.projects (id, name, deal_id, project_type, client_id, project_lead_id) VALUES
  ('b1000000-0000-0000-0000-000000000000', 'Vellor Meta Expansion', 'd1000000-0000-0000-0000-000000000000', 'ads', 'a4000000-0000-0000-0000-000000000000', 'a2000000-0000-0000-0000-000000000000'),
  ('b2000000-0000-0000-0000-000000000000', 'Oudfy Store Build', 'd2000000-0000-0000-0000-000000000000', 'website', 'a5000000-0000-0000-0000-000000000000', 'a3000000-0000-0000-0000-000000000000'),
  ('b3000000-0000-0000-0000-000000000000', 'Pamya Master Campaign', 'd3000000-0000-0000-0000-000000000000', 'combined', 'a6000000-0000-0000-0000-000000000000', 'a2000000-0000-0000-0000-000000000000');
...
INSERT INTO public.project_tasks (id, project_id, assigned_to, assigned_by, title, task_type, category, status) VALUES
  ('c1000000-0000-0000-0000-000000000000', 'b3000000-0000-0000-0000-000000000000', 'a3000000-0000-0000-0000-000000000000', 'a2000000-0000-0000-0000-000000000000', 'Inject reviews onto the staging site', 'dev', 'Dev', 'ongoing');
